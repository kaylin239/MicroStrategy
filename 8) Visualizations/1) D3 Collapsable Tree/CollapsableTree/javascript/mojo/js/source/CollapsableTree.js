(function () { 
    ...
    mstrmojo.plugins.CollapsableTree.CollapsableTree = mstrmojo.declare(
        mstrmojo.CustomVisBase,
        null,
        {
            scriptClass: "mstrmojo.plugins.CollapsableTree.CollapsableTree",
